...
#1.Dado un diccionario en el que las claves son los nombres de distintas personas y los valores son 
...
#2.Contar cuántas veces aparece cada caracter en un texto dado.
text = 'Hola buenos dias, me llamo Rocio'
chars = {}
